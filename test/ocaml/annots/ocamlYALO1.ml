...
let x = "with_warning" (* this line will be too long because it has 95 chars in the same lin *)

[@@@yalo.warning "YALO-1"]

let x = "without_warning" (* this line will be too long because it has 98 chars in the same lin *)
...
let x = "without_warning" (* this line will be too long because it has 90 chars in the *)
