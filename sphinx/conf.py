...
# -*- coding: utf-8 -*-
#
# yalo documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'yalo.tex', 'yalo Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'yalo', 'yalo Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'yalo', 'yalo Documentation',
     author, 'yalo', 'One line description of project.',
     'Miscellaneous'),
]
